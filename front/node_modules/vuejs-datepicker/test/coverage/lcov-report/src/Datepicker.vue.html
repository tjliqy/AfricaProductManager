...
<html lang="en">
<head>
    <title>Code coverage report for src/Datepicker.vue</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> Datepicker.vue
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">99.24% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>261/263</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">97.57% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>201/206</span>
      </div>
      <div class='fl pad1y space-right2'>
...
854
855
856</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2963×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">5939×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">5939×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2553×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2553×</span>
<span class="cline-any cline-yes">2243×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
export default <span class="fstat-no" title="function not covered" >{</span>
  ...
  computed: {
    ...
    calendarStyle () {
      let styles = {}
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.$isServer) {
        let elSize = {
          top: 0,
          height: 0
        }
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.$el) {
...
&nbsp;
  ...
  methods: <span class="fstat-no" title="function not covered" >{</span>
    ...
    getDefaultDate () {
<span class="cstat-no" title="statement not covered" >      r</span>eturn new Date(new Date().getFullYear(), new Date().getMonth(), 1).getTime()
    },
    resetDefaultDate () {
      this.currDate = (</span>this.selectedDate === null) ? <span class="branch-0 cbranch-no" title="branch not covered" >this.getDefaultDate() : this.selectedDate.getTime()
    },
    isOpen () {
...
&nbsp;
      document.addEventListener('click', (e) =&gt; {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.$el &amp;&amp; !this.$el.contains(e.target)) {
          if (this.isInline()) {
            return this.showDayCalendar()
          }
   ...
   */
  mounted () {
<span class="cstat-no" title="statement not covered" >    t</span>his.init()
  }
}
// &lt;/script&gt;
//
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon Apr 10 2017 08:27:02 GMT+0100 (BST)
</div>
</div>
